...
!-----------------------------------------------------------------------
!  print out initial profile as a WRF-style input_sounding

    open(unit=99,file='mbm.input_sounding')
    write(99,*) p_sfc/100, th_sfc, qv_sfc*1000
    DO k=1,nk
      write(99,*) (k-0.5)*dz, th0(k), qv0(k)*1000, 0, 0
    ENDDO
